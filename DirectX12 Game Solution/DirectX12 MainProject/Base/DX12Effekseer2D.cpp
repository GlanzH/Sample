...
DX12Effekseer::CEffekseer2D::CEffekseer2D() :m_manager(nullptr),
m_renderer(nullptr),m_sfMemoryPoolEfk(nullptr), m_commandListEfk(nullptr)
{

}

DX12Effekseer::CEffekseer2D::~CEffekseer2D()
{
	Reset();
}
...
*/
bool DX12Effekseer::CEffekseer2D::Initialize()
{
	//エフェクトレンダラーの生成
...
/**
	@brief	Effekseerの解放
*/
void DX12Effekseer::CEffekseer2D::Reset()
{
	m_manager->Release();
	m_renderer->Release();
...
/**
	@brief	Effekseerの更新
*/
void DX12Effekseer::CEffekseer2D::Update(const float deltaTime)
{
	m_manager->Update();
...
/**
	@brief	Effekseerの描画
*/
void DX12Effekseer::CEffekseer2D::Renderer()
{
...
void DX12Effekseer::CEffekseer2D::SetCamera(DX12::CAMERA* camera)
{
	_camera = camera; 
...
*/
void DX12Effekseer::CEffekseer2D::SetCameraPosition(DX12::CAMERA* camera)
{
...
*/
void DX12Effekseer::CEffekseer2D::Play(std::string effectName)
{
...
void DX12Effekseer::CEffekseer2D::Play(std::string effectName, Vector3 pos)
{
	if (m_effects[effectName] == NULL)
		return;
...
EFFECTHANDLE DX12Effekseer::CEffekseer2D::Play(EFFECT effect ,Vector3 pos)
{
...
EFFECTHANDLE DX12Effekseer::CEffekseer2D::Play2D(EFFECT effect, Vector3 effectPosition)
{
...
/**
	...
	@param	effectName エフェクト名
*/
void DX12Effekseer::CEffekseer2D::PlayOneShot(std::string effectName)
{
...
void DX12Effekseer::CEffekseer2D::PlayOneShot(std::string effectName, Vector3 pos)
{
	if (m_handles[effectName] == NULL || !m_manager->Exists(m_handles[effectName]))
	{
		m_handles[effectName] = m_manager->Play(m_effects[effectName], pos.x, pos.y, pos.z);
...
void DX12Effekseer::CEffekseer2D::PlayOneShot2D(std::string effectName, Vector3 effectPosition)
{
	auto pos = DXTK->Direct3D9->ScreenToWorldPoint(Vector3(effectPosition.x, effectPosition.y, effectPosition.z), *_camera);
...
/**
	...
	@param	effectName エフェクト名
*/
void DX12Effekseer::CEffekseer2D::Stop(std::string effectName)
{
	m_manager->StopEffect(m_handles[effectName]);
}

void DX12Effekseer::CEffekseer2D::Stop(EFFECTHANDLE handle)
{
	m_manager->StopEffect(handle);
}

void DX12Effekseer::CEffekseer2D::AllStop()
{
...
/**
	...
	@param	effectName エフェクト名
*/
void DX12Effekseer::CEffekseer2D::Pause(std::string effectName)
{
...
void DX12Effekseer::CEffekseer2D::Pause(EFFECTHANDLE handle)
{
...
*/
void DX12Effekseer::CEffekseer2D::SetPosition(std::string effectName,Vector3 effectPosition)
{
...
void DX12Effekseer::CEffekseer2D::SetPosition(EFFECTHANDLE handle, Vector3 effectPosition)
{
	Effekseer::Vector3D position = Effekseer::Vector3D(effectPosition.x, effectPosition.y, effectPosition.z);
	m_manager->SetLocation(handle, position);
}

void DX12Effekseer::CEffekseer2D::SetPosition2D(std::string effectName, Vector3 effectPosition)
{
	auto pos = DXTK->Direct3D9->ScreenToWorldPoint(Vector3(effectPosition.x, effectPosition.y, effectPosition.z), *_camera);
...
void DX12Effekseer::CEffekseer2D::SetPosition2D(EFFECTHANDLE handle, Vector3 effectPosition)
{
	auto pos = DXTK->Direct3D9->ScreenToWorldPoint(Vector3(effectPosition.x, effectPosition.y, effectPosition.z), *_camera);
...
*/
void DX12Effekseer::CEffekseer2D::MoveEffect(std::string effectName, Vector3 position)
{
	Effekseer::Vector3D pos = Effekseer::Vector3D(position.x, position.y, position.z);
	m_manager->AddLocation(m_handles[effectName], pos);
}

void DX12Effekseer::CEffekseer2D::MoveEffect(EFFECTHANDLE handle, Vector3 position)
{
	Effekseer::Vector3D pos = Effekseer::Vector3D(position.x, position.y, position.z);
...
*/
void DX12Effekseer::CEffekseer2D::SetRotation(std::string effectName, Vector3 rotation)
{
	m_manager->SetRotation(m_handles[effectName], rotation.x, rotation.y, rotation.z);
}

void DX12Effekseer::CEffekseer2D::SetRotation(EFFECTHANDLE handle, Vector3 rotation)
{
...
/**
	...
	@param	scale		拡大率
*/
void DX12Effekseer::CEffekseer2D::SetScale(std::string effectName, Vector3 scale)
{
	m_manager->SetScale(m_handles[effectName], scale.x, scale.y, scale.z);
}

void DX12Effekseer::CEffekseer2D::SetScale(EFFECTHANDLE handle, Vector3 scale)
{
...
/**
	...
	@param	position	ポジション
*/
void DX12Effekseer::CEffekseer2D::SetTarget(std::string effectName, Vector3 position)
{
	Effekseer::Vector3D pos = Effekseer::Vector3D(position.x, position.y, position.z);
...
/**
	...
	@return 再生速度
*/
float DX12Effekseer::CEffekseer2D::GetSpeed(std::string effectName)
{
...
/**
	...
	@param	float		再生速度
*/
void DX12Effekseer::CEffekseer2D::SetSpeed(std::string effectName, float speed)
{
...
/**
	...
	@return	エフェクト
*/
EFFECT DX12Effekseer::CEffekseer2D::Create(LPCWSTR fileName, std::string effectName)
{
...
EFFECT DX12Effekseer::CEffekseer2D::Create(LPCWSTR fileName)
{
	EFFECT effect = Effekseer::Effect::Create(m_manager, (const EFK_CHAR*)fileName, 1.0f);
	return effect;
}
